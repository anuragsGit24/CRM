...
// Step 4: Handle project creation form submission.
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMessage === '' && (
        ...
        $sql = 'INSERT INTO projects (name, builder_id, location, address, flat_type, project_details, rera_no, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
...
<div class="layout">
    <header class="topbar">
        <div>
            ...
            <p class="subtitle">Add a project and link it to an active builder.</p>
        </div>
    ...
    <section class="card">
        ...
        <form method="post" action="">
            ...
            <p class="note">Required fields are marked with *. Builder dropdown only shows active builders.</p>
            <button class="submit" type="submit">Create Project</button>
        </form>
    </section>
</div>
</body>
