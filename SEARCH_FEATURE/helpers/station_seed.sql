...
(4, 'Grant Road', 'Western', 18.961922, 72.815803, 4, 'South Mumbai'),
...
-- 1: Vikhroli -> Vikhroli (Central Main), prev=Ghatkopar, next=Kanjurmarg, dist=2.871 km
UPDATE location SET nearest_station_id = 51, nearest_station_distance = 2.871 WHERE id = 1;
...
-- 4: Andheri East -> Andheri (Western), prev=Vile Parle, next=Jogeshwari, dist=2.711 km
UPDATE location SET nearest_station_id = 16, nearest_station_distance = 2.711 WHERE id = 4;
-- 5: Bandra West -> Bandra (Western), prev=Mahim Junction, next=Khar Road, dist=2.492 km
UPDATE location SET nearest_station_id = 12, nearest_station_distance = 2.492 WHERE id = 5;
...
-- 7: Kurla -> Kurla (Central Main), prev=Sion, next=Vidyavihar, dist=1.173 km
UPDATE location SET nearest_station_id = 48, nearest_station_distance = 1.173 WHERE id = 7;
-- 8: Ghatkopar West -> Ghatkopar (Central Main), prev=Vidyavihar, next=Vikhroli, dist=0.783 km
UPDATE location SET nearest_station_id = 50, nearest_station_distance = 0.783 WHERE id = 8;
-- 9: Ghatkopar East -> Ghatkopar (Central Main), prev=Vidyavihar, next=Vikhroli, dist=2.614 km
UPDATE location SET nearest_station_id = 50, nearest_station_distance = 2.614 WHERE id = 9;
-- 10: Thane West -> Thane (Central Main), prev=Mulund, next=Kalwa, dist=3.772 km
UPDATE location SET nearest_station_id = 56, nearest_station_distance = 3.772 WHERE id = 10;
-- 11: Thane East -> Thane (Central Main), prev=Mulund, next=Kalwa, dist=3.117 km
UPDATE location SET nearest_station_id = 56, nearest_station_distance = 3.117 WHERE id = 11;
-- 12: Mulund West -> Mulund (Central Main), prev=Nahur, next=Thane, dist=2.404 km
UPDATE location SET nearest_station_id = 55, nearest_station_distance = 2.404 WHERE id = 12;
-- 13: Mulund East -> Mulund (Central Main), prev=Nahur, next=Thane, dist=2.832 km
UPDATE location SET nearest_station_id = 55, nearest_station_distance = 2.832 WHERE id = 13;
-- 14: Bhandup West -> Bhandup (Central Main), prev=Kanjurmarg, next=Nahur, dist=1.758 km
UPDATE location SET nearest_station_id = 53, nearest_station_distance = 1.758 WHERE id = 14;
...
-- 16: Goregaon West -> Goregaon (Western), prev=Ram Mandir, next=Malad, dist=2.565 km
UPDATE location SET nearest_station_id = 19, nearest_station_distance = 2.565 WHERE id = 16;
-- 17: Goregaon East -> Goregaon (Western), prev=Ram Mandir, next=Malad, dist=2.613 km
UPDATE location SET nearest_station_id = 19, nearest_station_distance = 2.613 WHERE id = 17;
...
-- 20: Kandivali West -> Kandivali (Western), prev=Malad, next=Borivali, dist=2.029 km
UPDATE location SET nearest_station_id = 21, nearest_station_distance = 2.029 WHERE id = 20;
-- 21: Kandivali East -> Kandivali (Western), prev=Malad, next=Borivali, dist=2.334 km
UPDATE location SET nearest_station_id = 21, nearest_station_distance = 2.334 WHERE id = 21;
-- 22: Borivali West -> Borivali (Western), prev=Kandivali, next=Dahisar, dist=4.248 km
UPDATE location SET nearest_station_id = 22, nearest_station_distance = 4.248 WHERE id = 22;
-- 23: Borivali East -> Borivali (Western), prev=Kandivali, next=Dahisar, dist=6.868 km
UPDATE location SET nearest_station_id = 22, nearest_station_distance = 6.868 WHERE id = 23;
-- 24: Dahisar West -> Dahisar (Western), prev=Borivali, next=Mira Road, dist=2.995 km
UPDATE location SET nearest_station_id = 23, nearest_station_distance = 2.995 WHERE id = 24;
-- 25: Dahisar East -> Dahisar (Western), prev=Borivali, next=Mira Road, dist=3.297 km
UPDATE location SET nearest_station_id = 23, nearest_station_distance = 3.297 WHERE id = 25;
...
-- 27: Navi Mumbai -> Vashi (Harbour CSMT-Panvel), prev=Mankhurd, next=Sanpada, dist=3.095 km
UPDATE location SET nearest_station_id = 104, nearest_station_distance = 3.095 WHERE id = 27;
-- 28: Kharghar -> Kharghar (Harbour CSMT-Panvel), prev=Belapur CBD, next=Mansarovar, dist=5.342 km
UPDATE location SET nearest_station_id = 110, nearest_station_distance = 5.342 WHERE id = 28;
-- 29: Panvel -> Panvel (Harbour CSMT-Panvel), prev=Khandeshwar, next=NULL, dist=12.286 km
UPDATE location SET nearest_station_id = 113, nearest_station_distance = 12.286 WHERE id = 29;
-- 30: Vashi -> Vashi (Harbour CSMT-Panvel), prev=Mankhurd, next=Sanpada, dist=1.480 km
UPDATE location SET nearest_station_id = 104, nearest_station_distance = 1.480 WHERE id = 30;
-- 31: Worli -> Prabhadevi (Western), prev=Lower Parel, next=Dadar, dist=1.456 km
UPDATE location SET nearest_station_id = 8, nearest_station_distance = 1.456 WHERE id = 31;
-- 32: Lower Parel -> Lower Parel (Western), prev=Mahalaxmi, next=Prabhadevi, dist=1.912 km
UPDATE location SET nearest_station_id = 7, nearest_station_distance = 1.912 WHERE id = 32;
-- 33: Dadar -> Dadar (Western), prev=Prabhadevi, next=Matunga Road, dist=1.035 km
UPDATE location SET nearest_station_id = 9, nearest_station_distance = 1.035 WHERE id = 33;
-- 34: Chembur -> Chembur (Harbour CSMT-Panvel), prev=Tilak Nagar, next=Govandi, dist=1.889 km
UPDATE location SET nearest_station_id = 101, nearest_station_distance = 1.889 WHERE id = 34;
-- 35: Sion -> Sion (Central Main), prev=Matunga, next=Kurla, dist=1.363 km
UPDATE location SET nearest_station_id = 47, nearest_station_distance = 1.363 WHERE id = 35;
...
-- 37: Juhu -> Andheri (Western), prev=Vile Parle, next=Jogeshwari, dist=1.450 km
UPDATE location SET nearest_station_id = 16, nearest_station_distance = 1.450 WHERE id = 37;
-- 38: Vile Parle West -> Vile Parle (Western), prev=Santacruz, next=Andheri, dist=3.913 km
UPDATE location SET nearest_station_id = 15, nearest_station_distance = 3.913 WHERE id = 38;
-- 39: Santacruz West -> Santacruz (Western), prev=Khar Road, next=Vile Parle, dist=2.133 km
UPDATE location SET nearest_station_id = 14, nearest_station_distance = 2.133 WHERE id = 39;
-- 40: Santacruz East -> Santacruz (Western), prev=Khar Road, next=Vile Parle, dist=2.724 km
UPDATE location SET nearest_station_id = 14, nearest_station_distance = 2.724 WHERE id = 40;
...
-- 43: Airoli -> Airoli (Trans Harbour Thane-Panvel), prev=Thane, next=Rabale, dist=1.532 km
UPDATE location SET nearest_station_id = 140, nearest_station_distance = 1.532 WHERE id = 43;
-- 44: Belapur -> Belapur CBD (Harbour CSMT-Panvel), prev=Seawoods-Darave, next=Kharghar, dist=6.284 km
UPDATE location SET nearest_station_id = 109, nearest_station_distance = 6.284 WHERE id = 44;
-- 45: Nerul -> Nerul (Harbour CSMT-Panvel), prev=Juinagar, next=Seawoods-Darave, dist=1.471 km
UPDATE location SET nearest_station_id = 107, nearest_station_distance = 1.471 WHERE id = 45;
-- 46: Kalyan -> Kalyan Junction (Central Main), prev=Thakurli, next=NULL, dist=2.064 km
UPDATE location SET nearest_station_id = 62, nearest_station_distance = 2.064 WHERE id = 46;
-- 47: Dombivli -> Dombivli (Central Main), prev=Diva Junction, next=Thakurli, dist=1.088 km
UPDATE location SET nearest_station_id = 60, nearest_station_distance = 1.088 WHERE id = 47;
...
-- 50: Vasai -> Vasai Road (Western), prev=Naigaon, next=Nalasopara, dist=4.285 km
UPDATE location SET nearest_station_id = 27, nearest_station_distance = 4.285 WHERE id = 50;
-- 51: Palghar -> Palghar (Western), prev=Kelve Road, next=Umroli, dist=71.849 km
UPDATE location SET nearest_station_id = 33, nearest_station_distance = 71.849 WHERE id = 51;
...
-- 54: Neral -> Neral (Central Khopoli Branch), prev=Vangani, next=Bhivpuri Road, dist=32.337 km
UPDATE location SET nearest_station_id = 81, nearest_station_distance = 32.337 WHERE id = 54;
-- 55: Karjat -> Karjat (Central Khopoli Branch), prev=Bhivpuri Road, next=Palasdhari, dist=48.708 km
UPDATE location SET nearest_station_id = 83, nearest_station_distance = 48.708 WHERE id = 55;
-- 56: Titwala -> Titwala (Central Kasara Branch), prev=Ambivli, next=Khadavli, dist=8.460 km
UPDATE location SET nearest_station_id = 66, nearest_station_distance = 8.460 WHERE id = 56;
-- 57: Bhiwandi -> Thane (Central Main), prev=Mulund, next=Kalwa, dist=13.444 km
UPDATE location SET nearest_station_id = 56, nearest_station_distance = 13.444 WHERE id = 57;
-- 58: Taloja -> Khandeshwar (Harbour CSMT-Panvel), prev=Mansarovar, next=Panvel, dist=9.968 km
UPDATE location SET nearest_station_id = 112, nearest_station_distance = 9.968 WHERE id = 58;
-- 59: Kamothe -> Mansarovar (Harbour CSMT-Panvel), prev=Kharghar, next=Khandeshwar, dist=7.775 km
UPDATE location SET nearest_station_id = 111, nearest_station_distance = 7.775 WHERE id = 59;
-- 60: Ulwe -> Belapur CBD (Harbour CSMT-Panvel), prev=Seawoods-Darave, next=Kharghar, dist=5.406 km
UPDATE location SET nearest_station_id = 109, nearest_station_distance = 5.406 WHERE id = 60;
